...
import dsa.a510.a1560055_0502.R;
...
public class MainActivity extends AppCompatActivity {
    ...
    protected ArrayList<Double> arSensor0;
    protected ArrayList<Double> arSensor1;
    protected ArrayList<Double> arSensor2;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btViewSensor0.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                else showMsg("arSenser0 is empty");
            }
        });
    ...
    private void parseSensorLine(String sLine) {
        ...
        if (stToken.toString().equals("getset")) {
            ...
            saveSansorval(nSensor, sensorVal);
        }
    }

    private void saveSansorval(long nSensor, double sensorVal) {
